...
const HamburgerMenu = ({ openMenu, setOpenMenu }: Props) => {
    ...
    return (
        <div id="nav-icon1" className={`z-4 fixed top-0 right-0 transition delay-150 duration-50 ease-in-out w-[60px] h-[45px] my-[50px] mx-auto rotate-0 cursor-pointer  md:hidden lg:hidden `} onClick={() => setOpenMenu(toggle => !toggle)}>
