        ...
        <>
            ...
            <main className={`bg-[url('/images/hfa_scroll.webp')] bg-center bg-cover bg-origin-border ${screenBG} bg-blend-overlay`} >
                ...
                <section className=" rounded-2xl box-border p-2 w-full relative top-0 my-5">
                    ...
                    />
                    <p className={`${pBG} indent-1 bg-(--background-alpha) absolute bottom-0 md:-bottom-12 md:right-66 w-full md:w-2/5 rounded-2xl shadow-black shadow-2xl box-border p-2`}>
                ...
                <section className=" rounded-2xl box-border p-2 w-full relative flex-row-reverse my-5 top-0">
                    ...
                    />
                    <p className={`${pBG} indent-1 bg-(--background-alpha) absolute bottom-0 md:-bottom-5 md:left-66 md:w-2/5 rounded-2xl shadow-black shadow-2xl box-border md:p-2`}>
                ...
                <section className=" rounded-2xl box-border p-2 w-full my-5 relative top-0">
                    ...
                    />
                    <p className={`${pBG} indent-1 bg-(--background-alpha) absolute bottom-0 md:bottom-50 md:right-66 w-full md:w-2/5 rounded-2xl shadow-black shadow-2xl box-border p-2`}>
                ...
                <section className=" rounded-2xl box-border p-2 w-full relative flex-row-reverse my-10 top-0">
                    <Image
                        ...
                        className="md:rounded-lg w-full md:w-3/5 size-1/1 md:block flex md:relative md:justify-self-end-safe md:m-10 md:shadow-md"
                    />
                    <article className={`${pBG} indent-1 bg-(--background-alpha) md:left-66 absolute md:my-10  bottom-0 md:bottom-50 w-full md:w-2/5 rounded-2xl shadow-black shadow-2xl box-border p-2`}>
                        <p className={`${pBG}`}>
